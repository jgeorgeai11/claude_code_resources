---
name: cms-iom
description: Answer questions about CMS operational policy, claims processing, benefit policy, or program administration using the CMS Internet-Only Manuals (IOMs).
---
...
1. **Use the appropriate MCP tools** — Data is in the `cms_iom` schema of the `policy_db` database
...
1. **Research** — Query the CMS IOM database to answer the policy question
